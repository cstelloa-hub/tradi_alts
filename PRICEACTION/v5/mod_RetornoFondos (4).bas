...
'===============================================================================
' mod_RetornoFondos  -  v1.7  -  21/09/2026
'
...
Public Sub ActualizarTodo()
    ...
    MsgBox "v1.7 - ActualizarTodo terminado en " & Format$(Timer - mT0, "0.0") & " s." & vbCrLf & vbCrLf & _
           sNotaFuente & _
           mPasos & vbCrLf & _
...
Falla:
    ...
    Application.StatusBar = False
    MsgBox "v1.7 - ActualizarTodo se detuvo." & vbCrLf & vbCrLf & msg & vbCrLf & vbCrLf & _
