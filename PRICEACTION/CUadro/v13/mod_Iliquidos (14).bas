...
Public Sub CrearFondos()
    ...
    If existia Then
        ...
        MsgBox "La hoja " & SH_FON & " ya existe y no se toca." & vbCrLf & vbCrLf & _
               "Pega ahi el codigo SBS y los retornos de cada fondo tradicional." & vbCrLf & _
               "El peso sale del FMS, no lo pegues.", vbInformation, "Fondos"
        Exit Sub
    End If

    cab = Array("Codigo SBS", "Nombre (referencia)", "Curr. Yield", _
    ...
    ws.Range("A6").Value = "2. Columnas D a I: los retornos del otro libro, en tanto por uno (0.0325 = 3.25%)."
    ws.Range("A7").Value = "3. El nombre de la columna B es solo para que te ubiques; el cuadro usa el de Instrumentos."
    ws.Range("A8").Value = "4. El peso F1/F2 sale del FMS. No lo pegues aqui."
    ws.Range("A9").Value = "5. Curr. Yield puede ir vacio."
    ...
    MsgBox "Hoja " & SH_FON & " creada." & vbCrLf & vbCrLf & _
           "Pega ahi el codigo SBS y los retornos de cada fondo tradicional." & vbCrLf & _
           "El peso sale solo del FMS." & vbCrLf & vbCrLf & _
           "Si la dejas vacia, esos fondos salen sin retorno en el cuadro.", _
