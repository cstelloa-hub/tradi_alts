...
'===============================================================================
' mod_RetornoFondos  -  v2.1  -  21/09/2026
'
...
Public Sub ActualizarTodo()
    ...
    MsgBox "v2.1 - ActualizarTodo terminado en " & Format$(Timer - mT0, "0.0") & " s." & vbCrLf & vbCrLf & _
           sNotaFuente & _
           mPasos & vbCrLf & _
...
Falla:
    ...
    texto = "v2.1 - ActualizarTodo se detuvo." & vbCrLf & vbCrLf & msg & vbCrLf & vbCrLf & _
...
Siguiente:
    ...
    If libro = "TRAD" Then ActualizarHojaMonedas fuenteMon, conteoMon
...
Private Sub ActualizarHojaMonedas(fuenteMon As Object, conteoMon As Object)
    ...
    For Each k In fuenteMon.Keys
        ...
        End If
        ws.Cells(i, 3).Value = fuenteMon(nom)
...
Public Sub AplicarMonedas()
    ...
    Recalcular
    MsgBox "Monedas aplicadas: " & n & " marcas reclasificadas." & vbCrLf & _
           "El cuadro ya esta rearmado.", vbInformation, "AplicarMonedas"
    Exit Sub
